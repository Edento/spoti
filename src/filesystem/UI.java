...
public class UI {
    ...
    private void addFile() {
        ...
        String directory = parseParentDirName();
    ...
    private void addDirectory() {
        ...
        String parentDir = parseParentDirName();
    ...
    private String parseParentDirName() {
    ...
    private boolean isValidLength(String name) {
        ...
        if (name != null && (name.length() > MAX_NAME_LENGTH)) {
            System.out.println("Error: file name cannot be more than " + MAX_NAME_LENGTH);
            return false;
        }
        return true;
    }
